...
const filePaths = [ ...(pkg.files || []), pkg.main, pkg.module ].filter((filePath) => (filePath != null && filePath.startsWith("!") === false));
...
_execCmd(`git commit -m "version bump (v${pkg.version})"`, "commit version changes");
