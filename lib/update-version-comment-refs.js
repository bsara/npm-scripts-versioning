...
const { name, files, main, module, version } = require(path.join(process.cwd(), 'package.json')); // eslint-disable-line no-shadow



const filePaths = [ ...(files || []), main, module ].filter((filePath) => (filePath.startsWith("!") === false));
